...
To get started, enable searching capabilities in your model by adding the `MyPharmaBr\Plastic\Searchable` trait:
...
```php
use MyPharmaBr\Plastic\Map\Blueprint;
use MyPharmaBr\Plastic\Mappings\Mapping;

...
class MappingRepositoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $repo = $this->getMock('MyPharmaBr\Plastic\Mappings\Mappings', ['getLastBatchNumber'], [
    ...
    {
        return new \MyPharmaBr\Plastic\Mappings\Mappings(Mockery::mock('Illuminate\Database\ConnectionResolverInterface'), 'mappings');
    }
}

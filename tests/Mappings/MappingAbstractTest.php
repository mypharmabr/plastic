...
class MappingAbstractTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->setExpectedException('MyPharmaBr\Plastic\Exception\MissingArgumentException');
...
class MappingWithSearchableModel extends \MyPharmaBr\Plastic\Mappings\Mapping
{
    public $model = 'SearchableModel';
}

class MappingWithNotSearchableModel extends \MyPharmaBr\Plastic\Mappings\Mapping
{
    public $model = 'NotSearchableModel';
}

class MappingWithoutModel extends \MyPharmaBr\Plastic\Mappings\Mapping
{
}
